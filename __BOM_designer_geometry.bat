...
# ATTENTION: NOTICE: WARNING: Unusual. Has workaround for MSW port of UNIX/KDE Dolphin file manager, changing directory to same directory as the anchor file.
...
export anchorSourceDir="BOM_designer"
...
REM ATTENTION: NOTICE: WARNING: Unusual. Has workaround for MSW port of UNIX/KDE Dolphin file manager, changing directory to same directory as the anchor file.
cd %~dp0
...
SET "MSWanchorSourceDir=BOM_designer"
